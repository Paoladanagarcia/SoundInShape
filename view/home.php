...
<main>
    ...
    <div class="overlay3">
        <h3>Notre mission?</h3>
        <p>Vous permettre d'atteindre votre but. Vous proposer un environnement sonore adapté à vos besoins, selon vos capacités, vos disponibilités et vos objectifs. Nous travaillons sur l'optimisation du son qui vous entoure dans vos séances afin que vous donniez le meilleur de vous même ! </p>
    </div>
