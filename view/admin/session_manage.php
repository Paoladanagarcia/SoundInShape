<?php
global $session;
$GLOBALS['PAGE_TITLE'] = 'Gérer une session';
...
<main class="container">
    ...
    <form action="<?= url('/post-manage-session') ?>" method="post">
        ...
        <label for="voted_noise_level">Niveau de bruit voté</label>
        <input type="text" name="voted_noise_level" id="voted_noise_level" value="<?= $session['voted_noise_level'] ?>">

        <label for="time_noise_level_approved">Niveau de bruit approuvé (date)</label>
