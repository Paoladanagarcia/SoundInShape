<?php
global $cgu;
$GLOBALS['PAGE_TITLE'] = 'Gérer les CGU';
...
<main>
    <table>
        ...
        <tbody>
                ...
                <tr>
                    ...
                    <td>
                        <form>
                            ...
                            <input type="submit" value="Modifier" onclick="update_cgu(event)" />
                        </form>
                    ...
                    <td>
                        <form>
                            <input type="hidden" name="cgu_id" value="<?= $elem['cgu_id'] ?>">
                            <input type="submit" value="Supprimer" onclick="delete_cgu(event)" />
                        </form>
                    </td>
                </tr>
            <?php endforeach ?>
            ...
            <tr>
                <td>Ajouter une nouvelle CGU</td>
                <td>
                ...
                <td>
                    <form>
                        <input type="submit" value="Ajouter" onclick="add_cgu(event)" />
                    </form>
                </td>
            </tr>
        </tbody>
